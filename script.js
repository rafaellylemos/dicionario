function CarregaDicionario() {
    var biografias = {
        ...
        bio07: {
          nome: "Liniker",
          imagem: "../Fotos/Liniker-1.jpg",
          descricao:  "Liniker de Barros Ferreira Campos, mais conhecida como Liniker, é uma cantora e compositora brasileira, a cantora não teve o pai presente enquanto crescia e foi criada pela mãe, Ângela Barros. Liniker tem um irmão sete anos mais novo, Vítor, a cantora vem de uma linhagem de músicos e recebeu o nome em homenagem ao jogador de futebol inglês Gary Liniker. A cantora revelou em uma entrevista à revista Marie Claire que foi abusada sexualmente aos doze anos por conhecidos da família. Liniker, na mesma entrevista, disse que começou a se entender como mulher depois de conviver com a cantora Linn da Quebrada, elas estudaram Teatro juntas em Santo André em 2014. Liniker utiliza o pronome feminino (ela/dela) e, além de cantora, também é atriz, ela fez uma participação como ela mesma na série brasileira da Netflix 3% (2016 – 2020) e, em 2021, interpretou Cassandra em Manhãs de Setembro, série brasileira da Amazon Prime.",
          citacao: "Eu não preciso ter uma certeza de ‘sou homem’ ou ‘sou mulher’, meu corpo é livre, meu corpo é um corpo político, ele merece a liberdade dele e eu preciso caminhar com isso, aceitar que eu sou assim.",
        },
        bio08: {
          nome: "Elza Soares",
          imagem: "../Fotos/Elza.jpg",
          descricao: "Elza Soares da Conceição (1930-2022) foi uma cantora e compositora brasileira. Um dos maiores nomes da MPB, Elza recebeu ano 2000, em Londres, o título de Melhor Cantora do Universo dado pela emissora BBC. Famosa pela voz rouca, Elza Soares foi um dos maiores nomes da música popular brasileira. Sua história de vida conta com tragédias e reviravoltas memoráveis.",
          citacao: "Não tenho medo da morte, porque acho que não vou morrer. Vou virar purpurina!",
        },
        bio09: {
          nome: "Maya Angelou",
          imagem: "../Fotos/Maya.jpg",
          ...
          citacao: "Toda vez que uma mulher se defende, sem nem perceber que isso é possível, sem qualquer pretensão, ela defende todas as mulheres.",
       },
        bio10: {
        nome: "Michelle Obama",
        imagem: "../Fotos/michelle.jpg",
        descricao:  "Bio Michelle",
        citacao: "Citação Michelle",
        },
        bio11: {
        nome: "Dandara dos Palmares",
        imagem: "../Fotos/dandara.jpg",
        descricao: "Bio Dandara",
        citacao: "Citação Dandara",
        },
        bio12: {
        nome: "Mercedes Baptista",
        imagem: "../Fotos/mercedes.jpg",
        descricao: "Bio Mercedes",
        citacao: "Citação Mercedes",
    },
        bio13: {
        nome: "Nina Simone",
        imagem: "../Fotos/nina.jpg",
        descricao:  "Bio Nina",
        citacao: "Citação Nina",
        },
        bio14: {
        nome: "Oprah Winfrey",
        imagem: "../Fotos/Oprah.png",
        descricao: "Bio Oprah",
        citacao: "Citação Oprah",
        },
        bio15: {
        nome: "Marsha P. Johnson",
        imagem: "../Fotos/marshapjohnson.jpg",
        descricao: "Bio Marsha",
        citacao: "Citação Marsha",
    },
};
...
for(var bio in biografias) {
    content.innerHTML += '<div class="card"> <img src="' + biografias[bio].imagem + '"/>' + "<details> <summary>" + biografias[bio].nome + "</summary> <p>" + biografias[bio].descricao + "<blockquote> <q>" + biografias[bio].citacao + "</q> </blockquote> </p> </details> </div>";
}
}
